! ( function ( t, e, i, s ) {
	...
	( p = {
		...
		( n.prototype.prepare = function ( e ) {
			const i = this.trigger( 'prepare', { content: e } );
			return (
				i.data ||
		...
		( n.prototype.to = function ( i, s ) {
			if ( this.settings.loop ) {
				let n = i - this.relative( this.current() ),
					o = this.current(),
					r = this.current(),
					a = this.current() + n,
					h = 0 > r - a ? ! 0 : ! 1,
				...
				a < this.settings.items && h === ! 1
					...
					( this.e._goToLoop = e.setTimeout(
						t.proxy( function () {
							this.speed(
								this.duration( this.current(), o + n, s )
							),
								this.current( o + n ),
								this.update();
						}, this ),
		...
		( n.prototype.destroy = function () {
			...
			for ( const s in this._plugins ) this._plugins[ s ].destroy();
	...
	( function ( t, e ) {
		...
		( i.Defaults = { lazyLoad: ! 1 } ),
			( i.prototype.load = function ( i ) {
				const s = this._core.$stage.children().eq( i ),
					n = s && s.find( '.owl-lazy' );
				! n ||
	...
	( function ( t, e, i ) {
			...
			( this._core = e ),
				...
				( this._handlers = {
					...
					'prepared.owl.carousel': t.proxy( function ( e ) {
						const i = t( e.content ).find( '.owl-video' );
						i.length &&
							( i.css( 'display', 'none' ),
		...
		( s.Defaults = { video: ! 1, videoHeight: ! 1, videoWidth: ! 1 } ),
			( s.prototype.fetch = function ( t, e ) {
				let i = t.attr( 'data-vimeo-id' ) ? 'vimeo' : 'youtube',
					s =
		...
		var i = function ( s ) {
			( this._core = s ),
				...
				t( e ).on(
					...
					t.proxy( function () {
						const t = e.location.hash.substring( 1 ),
