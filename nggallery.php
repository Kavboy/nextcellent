...
if (! class_exists('nggLoader') ) {
    ...
    class nggLoader
    {
        ...
        public string $version = '1.9.36';
        private string $dbversion = '1.8.4';
        ...
        function disable_upgrade( $option )
        {
            ...
            if (isset($option->response[ $this->plugin_name ]) ) {
				...
				if ( $this->add_PHP7_notice == false ) {
					add_action( "in_plugin_update_message-$this->plugin_name",
						function () {
							echo '<br /><span style="color:#ff0000">Please update to PHP7.3 as soon as possible, the plugin is not tested under PHP5 anymore</span>';
						}
					);
