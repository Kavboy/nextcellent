	...
	<table align="center" width="90%">
		<tr>
			...
			<td style="width: 200px;">
				...
				<label><input type="radio" name="ra" value="ccw">
				<?php
				esc_html_e(
		...
		<tr>
			<td style="text-align: center; vertical-align: middle; width: 60%">
				<div style="padding: 10px">
					<button class="crop-action button button-small" data-method="zoom" data-option="0.1" type="button" title="
					<?php
					_e(
						'Zoom In',
						'nggallery'
					...
					<button class="crop-action button button-small" data-method="rotate" data-option="-90" type="button" title="
					<?php
					_e(
						'Rotate Left',
						'nggallery'
					...
					<button class="crop-action button button-small" data-method="reset" type="button" title="
					<?php
					_e(
						'Reset',
						'nggallery'
					...
					<button id="center-selection" class="button button-small" data-method="reset" type="button" title="
					<?php
					_e(
						'Center selection',
						'nggallery'
