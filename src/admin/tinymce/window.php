...
wp_enqueue_script( 'ngg-autocomplete', NGGALLERY_URLPATH . 'src/admin/js/ngg.autocomplete.js', array( 'jquery-ui-autocomplete' ), '1.1' );
?>
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script language="javascript" type="text/javascript" src="<?php echo NGGALLERY_URLPATH; ?>src/admin/tinymce/tiny_mce_popup.js"></script>
		<script language="javascript" type="text/javascript" src="<?php echo NGGALLERY_URLPATH; ?>src/admin/tinymce/utils/mctabs.js"></script>
		<script language="javascript" type="text/javascript" src="<?php echo site_url(); ?>/wp-includes/js/tinymce/utils/form_utils.js"></script>
		<script language="javascript" type="text/javascript" src="<?php echo NGGALLERY_URLPATH; ?>src/admin/tinymce/tinymce.js"></script>
		<?php wp_print_styles(); ?>
		<style>
			.nggwrap {
				padding:10px;
	...
	<body class="nextgen_tinymce_window wp-admin wp-core-ui" id="link" style="display: none">
		...
		<script type="text/javascript">
		  document.addEventListener("DOMContentLoaded", function(){
				...
				jQuery('#types').on('change', function(){
			...
			function checkValues() {
				...
				let active = document.getElementsByClassName('current')[0].id;
				let required;
				let message;
				...
				switch (active) {
					case 'gallery_panel' :
						...
						console.log('window gallery_panel required: ', required);
						break;
